...
 
6. Indentation problems:<br>
Sometimes if directly compy&paste codes from a text editor, the indentation may be troublesome:<br>
Select the cell with problematic indentations, hit Tab to indent, then hit Shift + Tab to inverse indentation.<br> 
Besides, the above solution can also help clean up those weired-looking arrows indicating indentations in jupyter notebooks.<br>
